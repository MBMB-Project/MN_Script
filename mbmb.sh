...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mbmb.conf'
CONFIGFOLDER='/root/.mbmb'
COIN_DAEMON='mbmbd'
COIN_CLI='mbmb-cli'
...
addnode=108.61.162.105
addnode=108.61.246.18
addnode=45.77.247.234
addnode=95.179.146.150
addnode=95.179.208.53
addnode=140.82.38.183
addnode=140.82.7.213
addnode=149.248.59.40
addnode=45.63.97.209
addnode=149.28.174.199
...
function important_information() {
 ...
 echo -e "${BLUE}================================================================================================================================"
 echo -e "${CYAN}Follow twitter to stay updated.  https://twitter.com/mbmb${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${CYAN}Ensure Node is fully SYNCED with BLOCKCHAIN.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Usage Commands.${NC}"
 echo -e "${GREEN}mbmb-cli masternode status${NC}"
 echo -e "${GREEN}mbmb-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
